		            	...
		            	<div class="col-sm-6">
		            		...
		            		<form class="form-inline" id="productForm">
		            			<div class="form-group">
			            			...
			            			<button type="submit" class="btn btn-primary btn-lg btn-flat"><i class="fa fa-shopping-cart"></i>Purchase This Package</button>
			            		</div> 
		            		</form>
		            	</div>
		            	<div class="col-sm-6">
		            		<h1 class="page-header"><?php echo $product['prodname']; ?></h1>
		            		<h3><b>BDT <?php echo number_format($product['price'], 2); ?></b></h3>
